...
export default function LoginPage() {
  ...
  return (
    <main className="flex isolate items-center justify-center relative min-h-[100dvh] overflow-hidden bg-background text-foreground dark:bg-slate-950 dark:text-slate-50">
      ...
      <Section className="relative flex min-h-[100svh] flex-col items-center justify-center px-4">
        <div
          ...
          style={{
            background: "radial-gradient(60% 40% at 50% 40%, rgba(16,185,129,0.5), transparent 70%)",
          }}
        />
        ...
        >
          ...
          <h1 className="mt-6 text-4xl md:text-5xl font-bold tracking-tight text-balance">
            ...
            <span className="bg-gradient-to-r from-emerald-400 via-teal-300 to-emerald-400 bg-clip-text text-transparent [text-shadow:0_0_20px_rgba(16,185,129,0.18)]">
              painel de consorcios
            </span>
            .
          </h1>
          <p className="mt-4 text-slate-300 text-lg md:text-xl">
            Acompanhe leads, negociacoes e assembleias em um ambiente seguro, com previsibilidade e metodo.
          </p>
        </motion.div>
        ...
        >
          ...
          <p className="text-sm text-slate-400 mb-4">Escolha o melhor caminho para voce.</p>
              ...
              <form
                onSubmit={async (e) => {
                  ...
                  try {
                    ...
                    setMessage(error instanceof Error ? error.message : "Falha ao enviar o magic link.");
                  }
                }}
                className="space-y-4"
              >
                ...
                <p className="text-xs text-muted-foreground text-center">
                  Dica: cheque tambem o <strong>spam</strong>.
                </p>
              </form>
            </TabsContent>
              ...
              >
                ...
                <div>
                  ...
                  <div className="relative">
                    <Input id="password" name="password" type={showPass ? "text" : "password"} required className="pr-10" />
                    <button
                      type="button"
          ...
          {message ? <p className="mt-3 text-sm text-center text-muted-foreground">{message}</p> : null}
