...
import {
    cartaOperacaoSchema,
    type CartaOperacaoFormInput,
    type CartaOperacaoFormValues,
} from "../schemas/carta-operacao.schema";
import { updateCartaOperacaoAction } from "../actions/update-carta-operacao";
...
type Props = {
    ...
    initialValues: CartaOperacaoFormValues;
};
...
export function CartaOperacaoForm({
    ...
    const form = useForm<CartaOperacaoFormInput, unknown, CartaOperacaoFormValues>({
        ...
        defaultValues: {
            assembleiaDia:
                initialValues.assembleiaDia == null ? null : String(initialValues.assembleiaDia),
                ...
                <div className="grid gap-4">
                    ...
                    <Card className="border-white/10 bg-white/5">
                        ...
                        <CardContent className="space-y-3">
                            ...
                            <div className="rounded-xl border border-white/10 bg-black/10 p-3 text-sm text-muted-foreground">
                                Alterações estruturais de direcionamento devem ficar na aba <strong>Estratégia</strong>.
                                Configuração de embutido, FGTS e fixo deve ficar na aba <strong>Modalidades</strong>.
                            </div>
                        </CardContent>
                    </Card>
                </div>
