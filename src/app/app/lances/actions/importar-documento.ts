...
export type DocumentoImportado = {
    ...
    dados: {
        ...
        cliente_rg?: string;
        cliente_rg_orgao?: string;
        cliente_rg_emissao?: string;
        cliente_local_nascimento?: string;
        cliente_nome_mae?: string;
        cliente_nome_conjuge?: string;
        cliente_cpf_conjuge?: string;
        cliente_estado_civil?: string;
        cliente_profissao?: string;
        cliente_renda?: number;
        cliente_cep?: string;
